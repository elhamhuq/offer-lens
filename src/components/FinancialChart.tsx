...
export default function FinancialChart({
  ...
  const handleSuggestionClick = (monthlyAmount: number) => {
    ...
    setProjections(
      generateProjections(
        monthlyAmount,
        newAssumptions.annualReturn,
        newAssumptions.salaryGrowthRate
      )
    );
  ...
  const chartData: ChartData[] = [10, 20, 30].map(timeframe => {
    ...
    const currentProjection =
      filteredProjections[filteredProjections.length - 1];
    ...
    const annualReturn =
      totalContributions > 0
        ? ((totalGrowth / totalContributions) * 100) / timeframe
        : 0;
      ...
      chartData.forEach((_, index) => {
        ...
        const interval = setInterval(() => {
          ...
          setAnimationProgress(prev => ({
            ...prev,
            [timeframe]: Math.min(progress, 100),
          }));
          if (progress >= 100) {
        ...
        <CardContent className='space-y-3'>
          <div className='h-20 bg-gradient-to-br from-muted/30 to-muted/60 rounded-lg border border-border/50 overflow-hidden relative'>
            ...
            <svg
              ...
              onMouseMove={e =>
                handleMouseMove(e, data.timeframe, 'totalValue')
              }
              onMouseLeave={handleMouseLeave}
            >
              <defs>
                <linearGradient
                  id={`mini-gradient-${data.timeframe}`}
                  x1='0%'
                  y1='0%'
                  x2='0%'
                  y2='100%'
                >
                  <stop
                    offset='0%'
                    className='[stop-color:hsl(var(--chart-1))]'
                    stopOpacity='0.4'
                  />
                  <stop
                    offset='100%'
          ...
          <div className='text-center space-y-1'>
            ...
            <div className='flex items-center justify-center space-x-1 text-xs'>
              ...
              <span className='text-green-600 font-medium'>
                +{data.annualReturn.toFixed(1)}% avg
              </span>
            </div>
          </div>
        </CardContent>
        ...
        <CardContent className='space-y-8 pt-6'>
            ...
            <div className='space-y-3 animate-in fade-in-0 slide-in-from-left-4 duration-700'>
              ...
              <div className='h-40 bg-gradient-to-br from-muted/20 to-muted/50 rounded-xl border border-border/50 relative overflow-hidden shadow-inner'>
                ...
                >
                  <defs>
                    <linearGradient
                      id={`total-gradient-${data.timeframe}`}
                      x1='0%'
                      y1='0%'
                      x2='0%'
                      y2='100%'
                  ...
                  <path
                    ...
                    strokeWidth='3'
                    style={{
                      ...getPathAnimationStyle(
                        `total-${data.timeframe}`,
                        progress
                      ),
              ...
              <div className='flex items-center justify-between'>
                ...
                <div className='text-right'>
                  ...
                  <p className='font-bold text-chart-2'>
                    ${assumptions.monthlyInvestment.toLocaleString()}
                  </p>
                </div>
              </div>
              <div className='h-40 bg-gradient-to-br from-muted/20 to-muted/50 rounded-xl border border-border/50 relative overflow-hidden shadow-inner'>
                ...
                <svg
                  ...
                  preserveAspectRatio='none'
                  onMouseMove={e =>
                    handleMouseMove(e, data.timeframe, 'contributions')
                  }
                  onMouseLeave={handleMouseLeave}
                >
                  <defs>
                    <linearGradient
                      id={`contrib-gradient-${data.timeframe}`}
                      x1='0%'
                      y1='0%'
                      x2='0%'
                      y2='100%'
                    >
                      <stop
                        offset='0%'
                        className='[stop-color:hsl(var(--chart-2))]'
                        stopOpacity='0.5'
                      />
                      <stop
                        offset='100%'
              ...
              <div className='flex items-center justify-between'>
                ...
                <div className='text-right'>
                  ...
                  <p className='font-bold text-chart-3'>
                    {(assumptions.annualReturn * 100).toFixed(1)}%
                  </p>
                </div>
              </div>
              <div className='h-40 bg-gradient-to-br from-muted/20 to-muted/50 rounded-xl border border-border/50 relative overflow-hidden shadow-inner'>
                ...
                <svg
                  ...
                  preserveAspectRatio='none'
                  onMouseMove={e =>
                    handleMouseMove(e, data.timeframe, 'growth')
                  }
                  onMouseLeave={handleMouseLeave}
                >
                  <defs>
                    <linearGradient
                      id={`growth-gradient-${data.timeframe}`}
                      x1='0%'
                      y1='0%'
                      x2='0%'
                      y2='100%'
                    >
                      <stop
                        offset='0%'
                        className='[stop-color:hsl(var(--chart-3))]'
                        stopOpacity='0.5'
                      />
                      <stop
                        offset='100%'
          ...
          <div className='grid grid-cols-2 md:grid-cols-4 gap-4 pt-6 border-t border-border/50 animate-in fade-in-0 slide-in-from-bottom-4 duration-700 delay-300'>
            ...
            <div className='text-center p-4 bg-gradient-to-br from-muted/40 to-muted/60 rounded-xl border border-border/50 hover:bg-muted/70 transition-all duration-300 hover:scale-105'>
              ...
              <p className='font-bold text-lg text-chart-3'>
                {((data.growth / data.contributions) * 100).toFixed(0)}%
              </p>
            </div>
            <div className='text-center p-4 bg-gradient-to-br from-muted/40 to-muted/60 rounded-xl border border-border/50 hover:bg-muted/70 transition-all duration-300 hover:scale-105'>
              <p className='text-sm text-muted-foreground font-medium'>
              ...
              <p className='font-bold text-lg text-chart-4'>
                {(assumptions.salaryGrowthRate * 100).toFixed(1)}%
              </p>
            </div>
          </div>
        </CardContent>
      ...
      <div className='flex items-center justify-between'>
        ...
        {showControls && (
          <Button
            variant='outline'
            size='sm'
            className='hover:bg-muted/50 border-border/60 bg-transparent'
          >
      ...
      {showControls && hasOffers && (
        <Card className='bg-gradient-to-br from-card to-card/95 border-border/60 shadow-lg'>
          <CardHeader className='border-b border-border/50'>
            ...
            <CardDescription className='text-base'>
              Choose which analyzed job offer to use for projections (
              {jobOffers.length} available)
            </CardDescription>
          </CardHeader>
              ...
              {selectedOffer && (
                <div className='grid grid-cols-1 md:grid-cols-3 gap-6 p-8 bg-gradient-to-br from-muted/30 to-muted/50 rounded-xl border border-border/50 relative'>
                  ...
                  <div className='flex items-center space-x-4'>
                    ...
                    <div>
                      <p className='font-semibold text-xl'>
                        ${selectedOffer.netIncome.toLocaleString()}/mo
                      </p>
                      <p className='text-base text-muted-foreground'>
                        Net Income
                      </p>
                  ...
                  <div className='flex items-center space-x-4'>
                    ...
                    <div>
                      <p className='font-semibold text-xl'>
                        ${selectedOffer.savingsPotential.toLocaleString()}/mo
                      </p>
                      <p className='text-base text-muted-foreground'>
                        Savings Potential
                      </p>
      ...
      {showControls && selectedOffer && (
        <Card className='bg-gradient-to-br from-card to-card/95 border-border/60 shadow-lg'>
          <CardHeader className='border-b border-border/50'>
            ...
            <CardDescription className='text-base'>
              Adjust these settings to see how different investment strategies
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
              <div className='space-y-2'>
                ...
                <Input
                  ...
                  onBlur={e =>
                    handleInputBlur('monthlyInvestment', e.target.value)
                  }
                ...
                <p className='text-sm text-muted-foreground'>
                  Available: ${selectedOffer.savingsPotential.toLocaleString()}
                  /mo
                </p>
              </div>
              ...
              <div className='space-y-2'>
                ...
                <Input
                  ...
                  onChange={e =>
                    handleInputChange('salaryGrowth', e.target.value)
                  }
              ...
              <div className='space-y-4'>
                <div className='flex items-center space-x-3'>
                  ...
                  <Label className='text-base font-medium'>
                    AI Investment Suggestions for {selectedOffer.company}
                  </Label>
                  {loadingSuggestions && (
                  ...
                  {suggestions.map((suggestion, index) => (
                    <div key={index} className='relative group'>
                      <Button
                        ...
                        onClick={() =>
                          handleSuggestionClick(suggestion.monthlyAmount)
                        }
                      >
                        <div className='space-y-2'>
        ...
        >
          {expandedChart && (
            <div className='flex flex-col gap-4 w-56 shrink-0'>
              ...
              {chartData
                .filter(data => data.timeframe !== expandedChart)
                .map(data => renderCollapsedChart(data))}
            </div>
          )}
