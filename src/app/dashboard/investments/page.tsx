...
export default function InvestmentsPage() {
  ...
  const currentInvestments = investments.reduce((sum, inv) => sum + inv.monthlyAmount, 0)
  const savingsRate = monthlyIncome > 0 ? (currentInvestments / monthlyIncome) * 100 : 0
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xl font-bold text-foreground">Investment Planning</span>
              </div>
            </div>

            <Button onClick={savePortfolio} className="bg-primary hover:bg-primary/90">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-foreground mb-2">Investment Planning</h1>
          <p className="text-muted-foreground">
            Set up your investment portfolio and see how it affects your long-term financial goals.
          </p>
        </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <Card className="bg-card border-border">
              <CardHeader>
                ...
                <CardDescription>Set your income and expenses to determine investment capacity</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={investmentGoal} onValueChange={setInvestmentGoal}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="general">General Wealth Building</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                ...
                <div className="grid grid-cols-3 gap-4 pt-4 border-t border-border">
                  <div className="text-center">
                    ...
                    <p className="text-lg font-bold text-foreground">${availableBudget.toLocaleString()}</p>
                  </div>
                  <div className="text-center">
                    <p className="text-sm text-muted-foreground">Current Investments</p>
                    <p className="text-lg font-bold text-accent">${currentInvestments.toLocaleString()}</p>
                  </div>
                  <div className="text-center">
                    <p className="text-sm text-muted-foreground">Savings Rate</p>
                    <p className="text-lg font-bold text-chart-2">{savingsRate.toFixed(1)}%</p>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="space-y-6">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-foreground">${currentInvestments.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-muted-foreground">Annual Investment</span>
                    <span className="font-medium text-foreground">${(currentInvestments * 12).toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-foreground">{timeHorizon} years</span>
                  </div>
                </div>
                ...
                <div className="pt-4 border-t border-border">
                  <div className="text-center space-y-1">
                    ...
                    <p className="text-2xl font-bold text-accent">
                      ${((currentInvestments * 12 * Number.parseInt(timeHorizon) * 1.082) ** 1).toLocaleString()}
                    </p>
                    <p className="text-xs text-muted-foreground">Assuming 8.2% annual return</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  <div className="p-3 rounded-lg bg-accent/10 border border-accent/20">
                    <p className="text-sm font-medium text-foreground mb-1">Diversification</p>
                  ...
                  <div className="p-3 rounded-lg bg-primary/10 border border-primary/20">
                    <p className="text-sm font-medium text-foreground mb-1">Dollar-Cost Averaging</p>
                    <p className="text-xs text-muted-foreground">
                      Invest consistently regardless of market conditions to reduce timing risk.
                    </p>
                  </div>

                  <div className="p-3 rounded-lg bg-chart-2/10 border border-chart-2/20">
                    <p className="text-sm font-medium text-foreground mb-1">Low Fees</p>
                    <p className="text-xs text-muted-foreground">
                      Choose ETFs with low expense ratios to maximize long-term returns.
                    </p>
                  </div>

                  <div className="p-3 rounded-lg bg-chart-4/10 border border-chart-4/20">
                    <p className="text-sm font-medium text-foreground mb-1">Emergency Fund First</p>
                    <p className="text-xs text-muted-foreground">
                      Ensure you have 3-6 months of expenses saved before aggressive investing.
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="bg-muted/30 border-border">
              <CardHeader>
                ...
                <CardDescription>Based on your age and risk tolerance</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-foreground">US Total Market (VTI)</span>
                    <span className="text-sm font-medium text-foreground">60%</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-foreground">International (VXUS)</span>
