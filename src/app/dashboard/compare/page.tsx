      ...
      : [
          {
            ...
            investments: [
              { id: "1", name: "S&P 500 Index", monthlyAmount: 1200, etfTicker: "SPY", riskLevel: "medium" as const },
              {
                id: "2",
          ...
          },
          {
            ...
            investments: [
              ...
              { id: "4", name: "Bond Index", monthlyAmount: 300, etfTicker: "BND", riskLevel: "low" as const },
            ],
            createdAt: new Date(),
            updatedAt: new Date(),
          },
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xl font-bold text-foreground">Scenario Comparison</span>
              </div>
            </div>

            <div className="flex items-center space-x-2">
              <Button variant="outline" onClick={() => setShowAIAnalysis(!showAIAnalysis)} className="bg-transparent">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-foreground mb-2">Compare Scenarios</h1>
          <p className="text-muted-foreground">
            Analyze multiple job offers and investment strategies side-by-side to make informed decisions.
          </p>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="bg-card border-border hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>Add another job offer and investment strategy to compare</CardDescription>
              </CardHeader>
              <CardContent>
                <Link href="/dashboard/new-scenario">
            ...
            <Card className="bg-card border-border hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>Upload a PDF or document to extract job details automatically</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="bg-card border-border hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>Optimize your investment strategy for better long-term outcomes</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <Card className="bg-muted/30 border-border">
            <CardHeader>
              <CardTitle className="text-lg">Tips for Better Comparisons</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  <h4 className="font-medium text-foreground">Consider All Factors</h4>
                ...
                <div className="space-y-3">
                  <h4 className="font-medium text-foreground">Long-term Perspective</h4>
                  <ul className="text-sm text-muted-foreground space-y-1">
